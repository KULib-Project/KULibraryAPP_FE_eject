...
const sci=()=>{
  return(
      <View style={{backgroundColor:"#bff9ff",borderRadius:3,width:"12%",height:"30%",alignItems:"center",justifyContent:"center"}}>
...
const liter=()=>{
  return(
      <View style={{backgroundColor:"#ffebbf",borderRadius:3,width:"12%",height:"30%",alignItems:"center",justifyContent:"center"}}>
    ...
    <View>
      ...
      >
          <View style={styles.postBox}>
            ...
            <Text>D-29</Text>
            <TouchableOpacity><Text>참가하기</Text></TouchableOpacity>
            </View>
            </View>
          </View>
        </TouchableOpacity> 
