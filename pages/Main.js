    ...
    <StatusBar backgroundColor="transparent" barStyle="dark-content" />
      ...
      <View style={styles.btnOrganize}>
        <TouchableOpacity style={styles.btnMain}>
          <Text style={styles.btnText} onPress={() => navigation.navigate("Golink")}>도서관 혜택 바로가기</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.btnMain}>
          <Text style={styles.btnText} onPress={() => navigation.navigate("Board")} >자유게시판</Text>
        </TouchableOpacity>
      </View>
      <View style={styles.btnOrganize}>
        <TouchableOpacity style={styles.btnMain} onPress={() => navigation.navigate("Depart")} >
          <Text style={styles.btnText}>학과별 추천도서</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.btnMain} onPress={() => navigation.navigate("Studyclub")} >
      ...
      <ScrollView style={styles.ListBox}>
        ...
        <View style={{flexDirection:'row',justifyContent:"flex-start",borderBottomWidth:0.5}}>
        <View style={{flexDirection:'row',marginLeft:5}}>
        <Checkbox
        checkedComponent={<Icon name="star" size={25} color="yellow" />}
        uncheckedComponent={<Icon name="staro" size={25} color="#222" />}
        label=''
